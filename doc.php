...
<html>
  ...
  <div class="header">
    ...
    <form method="post" action="writemed.php">
        ...
        <div class="input-group">
            ...
            <input type="text" name="phys" placeholder="" required>
        </div>
            <div class="input-group">
                <label>Practice number: </label>
                <input type="number" name="pracnr" placeholder="" maxlength="6" required>
            </div>
            <div class="input-group">
                <label>Symptoms: </label>
                <input type="text" name="symp" placeholder="" maxlength="30" required>
            </div>
            <div class="input-group">
